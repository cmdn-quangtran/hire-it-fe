      ...
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid item xs>
          <Typography variant="body1" className="about-content">
            Welcome to our recruitment system! We provide a powerful and
            efficient solution for businesses to streamline their hiring
            processes. Our system offers features for job posting, applicant
            tracking, interview scheduling, and candidate evaluation. With a
            user-friendly interface and advanced search capabilities, you can
            quickly find and hire the best talents. We prioritize data security
            and privacy to safeguard your sensitive information. Job seekers can
            explore employment opportunities and connect with companies actively
            hiring. Our scalable and customizable system caters to small
            startups and large enterprises. Let us help you build a winning team
            ...
            {images.map((cap, index) => (
              <Grid key={index} item xs={12} sm={6} md={4} lg={3}>
                <img
                  src={cap}
                  alt="Caption"
                  className={`${classes.cap} images-about`}
                />
              </Grid>
            ))}
          </Grid>
