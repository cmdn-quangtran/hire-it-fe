...
const jobSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(upload_job.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(upload_job.rejected, (state) => {
      state.isLoading = false;
    });
    builder.addCase(upload_job.fulfilled, (state) => {
      state.isLoading = false;
    });
    builder.addCase(get_all_jobs.pending, (state) => {
      state.isLoading = true;
      state.jobs = [];
    });
    builder.addCase(get_all_jobs.rejected, (state) => {
      state.isLoading = false;
      state.jobs = [];
    });
    ...
    builder.addCase(get_all_jobs_owner.pending, (state) => {
      state.isLoading = true;
      state.jobs_owner = [];
    });
    builder.addCase(get_all_jobs_owner.rejected, (state) => {
      state.isLoading = false;
      state.jobs_owner = [];
    });
    ...
    builder.addCase(update_job_status.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(update_job_status.rejected, (state) => {
      state.isLoading = false;
    });
    ...
    builder.addCase(delete_job.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(delete_job.rejected, (state) => {
      state.isLoading = false;
    });
    builder.addCase(delete_job.fulfilled, (state) => {
      state.isLoading = false;
